...
window.booksData = [
     ...
     { title: 'Jorot Dian Susatyono , M.kom', cover: 'img/cover (6).png', pdf: 'pdf/kecerdasan_buatan.pdf' },
     { title: 'Hendri', cover: 'img/cover (7).png', pdf: 'pdf/cepatmahirpython.pdf' },
     { title: 'Dr. Joseph Teguh santoso, S.ko , M.kom', cover: 'img/cover (8).png', pdf: 'pdf/projekcodingdenganpython.pdf' },
     { title: 'Wes McKinney', cover: 'img/cover (9).png', pdf: 'pdf/python_for_data.pdf' },
     { title: 'Berd Klein', cover: 'img/cover (10).png', pdf: 'pdf/bernd_klein_python_data_analysis_a4.pdf' }
 ];
 


 window.booksData2 = [
     {title: 'OH Su Hyang' , cover: 'img/coverS (1).png' , pdf: 'pdf/bicara_itu_ada_seninya.pdf'},
     {title: 'Dr. Agus Wibowo , M.kom , M.Si , MM' , cover: 'img/coverS (2).png' , pdf: 'pdf/teori_kewirausahawan.pdf'},
     {title: 'Dr.Ir. Agus Wibowo , M.kom , M.Si , MM' , cover: 'img/coverS (3).png' , pdf: 'pdf/pengaturan_uang.pdf'},
     {title: 'Henri Manampiring' , cover: 'img/coverS (4).png' , pdf: 'pdf/filosofiteras.pdf'}
]